...
- **Tag Library**: Visual tag library section showing all uploaded documents with their extracted MBTI/Jungian tags. Features interactive tag cloud with frequency counts and document browsing by tags. Tags are stored in localStorage and synced with Pinecone metadata.
