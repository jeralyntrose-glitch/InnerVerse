...
- **Document Management**: `DELETE /documents/{document_id}` for removing document data; `PATCH /documents/{document_id}/rename` for renaming documents (updates metadata in all Pinecone vectors); chat commands for `list`, `delete`, `show`.
