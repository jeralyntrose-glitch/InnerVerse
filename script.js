...
deleteAllBtn.addEventListener('click', async () => {
  const confirmed = confirm(
    '⚠️ WARNING: This will permanently delete ALL uploaded documents from your database.\n\n' +
  ...
  try {
    ...
    // Clear localStorage
    localStorage.removeItem('axis_mind_uploads');
    uploadedFiles = [];
    
    alert('✅ All documents have been permanently deleted from the database.');
    
    setTimeout(() => {
      deleteAllBtn.textContent = '🗑️ Delete All Documents';
