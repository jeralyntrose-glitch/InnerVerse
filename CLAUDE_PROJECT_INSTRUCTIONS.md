...
1. Make a POST request to `https://axis-of-mind.replit.app/query`
2. Set `document_id` to `""` (empty string) to search ALL documents
3. Set `question` parameter to user's exact question
4. Read and analyze the document-grounded content returned
