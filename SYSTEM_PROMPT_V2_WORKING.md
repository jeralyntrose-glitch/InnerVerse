...
**Evidence**: INFJ relationship response was perfect - user confirmed "exactly what I wanted"
...
- **Why it works**: Simplified 3-step workflow, clear personality, CS Joseph style without overwhelming complexity
- **What to avoid**: Don't add excessive instructions, overly detailed workflows, or complex meta-rules that cause Claude to overthink
